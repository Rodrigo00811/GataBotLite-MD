...
description = official[0][0] == String(contact[0]) ? 'Solo temas de WABOT-MD' : official[1][0] == String(contact[0]) ? 'Solo temas de WABOT-MD' : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? 'Solo temas de WABOT-MD' : desc === '' ? lenguajeGB.smsContacto5() : desc
