...
- INICIAR
> Use estos comandos dentro de la carpeta Polar-MD
```bash
...
```
- REANUDAR 
> Reanudar los procesos, usar dentro de la carpeta Polar-MD 
```bash
pm2 start index.js 
```
- VISUALIZAR EL PROCESO
> Usar dentro de la carpeta Polar-MD para ver en tiempo real
```bash
pm2 logs 
```
